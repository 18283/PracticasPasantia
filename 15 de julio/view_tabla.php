...
require_once 'USUARIOS/editarformulario.php';
    ...
    public function mostrarTabla($datos_array = null) {
        ...
        //Lo que dirije a al link de editar
            if ($mostrarEdicion || $mostrarBorrado) {
                ...
                $formularioEdicion = new mostrarFormularioEdicion($datosUs);

                echo "<td class='edit-icon-cell'>";
                if ($mostrarEdicion) {
                    echo "<a href='{$this->rutaEdicion}?id=$id' class='edit-icon' title='Editar'>📝</a>";
