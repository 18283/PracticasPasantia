...
$email = null;
$foto = null;
$imagenAnonimo = '../Recursos/anonimo.jpg';


if (isset($_GET['editar'])) {
    $editar_id = $_GET['editar'];
    $consulta = "SELECT BADGENUMBER, NAME, PASSWORD, EMail, PHOTO FROM USERINFO WHERE BADGENUMBER = ?";
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item text-white">
                    <a class="nav-link text-white h1" href="../VISTAS/index.html" onclick="return confirm('¿ESTAS ? DEGURO QUE QUIERES SALIR DE LA PAGINA');">CERRAR</a>
                </li>
            </ul>
